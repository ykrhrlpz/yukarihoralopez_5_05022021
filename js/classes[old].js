...
// function to render photographers. When it has a  parameter, it will call the filterPhotographersByTag funtion to filter photographers. When there is no parameter, it will map directly photographers to render all of them.
// const renderProfiles = (tagFilter) =>
// {
  
//   // check if funtion has a parameter
//   let photographersToDisplay = tagFilter ? filterPhotographersByTag(tagFilter) : photographers
...
const displayProfilesInHome = (photographers) =>
{
    for (let photographer of photographers)
    {
        ...
        console.log(photographer.showPage())
    }
